...
<body>
	...
	<div class="holder" style="margin-top: 60px;">
	  <section class="slider">
            <div class="flexslider">
	      <div class="slider-content text-center hidden-phone">
        ...
        <div class="holder-top" style="padding-top: 120px;">
            <div class="container">

              <!--HOME-->
              <div id="home" style="display:block;">
                 <div class="container_row-fluid">
                   <div class="row-fluid">
                        <div class="span6">
                            <h4 class="spl">How it Works</h4>
                            <iframe width="100%" height="306" src="http://www.youtube.com/embed/-URR4IL0jEI" frameborder="0" allowfullscreen="1"></iframe>
                            <div class="main-page-signin-linkedin">
                    ...
                    <div class="about-parent">
                        <div class="about-left-div">
                            ...
                            <div class="about-bullets">
                                <span>&#8226;</span><p>&nbsp;&nbsp;Connect with professionals from top companies</p>
                                <span>&#8226;</span><p>&nbsp;&nbsp;Gain interview experience with mock interviews</p>
                                <span>&#8226;</span><p>&nbsp;&nbsp;Get feedback and share the results</p>
                            </div>
                        </div>
                        <div class="about-right-div">
                            <div class="about-title-div">be an interviewer</div>
                            <div class="about-bullets">
                                <span>&#8226;</span><p>&nbsp;&nbsp;Expand your network with new talents</p>
                                <span>&#8226;</span><p>&nbsp;&nbsp;Help new talents by interviewing them</p>
                                <span>&#8226;</span><p>&nbsp;&nbsp;feedback and promote the talents you like</p>
                            </div>
                        </div>
                    </div>
                    <div class="container_test">
                        <div class="test">
                            <div class="testimonials-title-div">
                                Testimonials
                            </div>
                            <div class="container">
                                <div class="row-fluid">
                                    <div class="testimonial-div">
                                        ...
                                        <div class="testimonial-text-div">
                                            ...
                                            <p class="name">Davie Johnson</pclass="name">
                ...
                <div class="holder-bottom">
                    <div class="container">
                        <div class="row-fluid">
                            ...
                            <div class="footer-section fs4 footer-contact-us">
                                <h6>Contact Us</h6>
                                <form action="#">
