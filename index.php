          ...
          <div class="search-filters-div-content">
            ...
            <div class="search_filter">
              <select id="historyFilter_date" onchange="doShowHistory();">
                ...
                <option value=""
                  < 1 month ago">< 1 month ago</option>
                    ...
                    <div class="sc-left-info">
                      ...
                      <div id="scheduleDescription_inpersoninterview" style="display:none;">
                        <p style="font-weight: bold;">
                          in-person interview around <span class="description-emphasis" id="scheduleLocality">redmond wa</span>
                        </p>You will meet with your mock interviewer in a place of your choice.
                        You can allocate your time on solely being interviwed or ask about specifics of the interview process.
                        Having tips about a particular company's interviewing process is always helpful.
                      </div>
                    ...
                    <div class="sc-left-info">
                      ...
                      <div class="sc-left-calendar-time-div">
                        ...
                        <div id="scheduleTime" class="sc-left-time-selection-div" style="margin-top: -50px;">
                          <input type="radio" name="group1" value="7-8-AM">
                            7:00 AM - 8:00 AM<br />
                            <input type="radio" name="group2" value="8-9-AM">
                              8:00 AM - 9:00 AM<br />
                              <input type="radio" name="group3" value="9-10-AM">
                                9:00 AM - 10:00 AM<br />
                                <input type="radio" name="group4" value="10-11">
                                  10:00 AM - 11:00 AM<br />
                                  <input type="radio" name="group5" value="11-12">
                                    11:00 AM - 12:00 PM<br />
                                    <input type="radio" name="group6" value="12-8">
                                      12:00 PM - 1:00 PM<br />
                                      <input type="radio" name="group7" value="1-2">
                                        1:00 PM - 2:00 PM<br />
                                        <input type="radio" name="group8" value="2-3">
                                          2:00 PM - 3:00 PM<br />
                                          <input type="radio" name="group9" value="3-4">
                                            3:00 PM - 4:00 PM<br />
                                            <input type="radio" name="group10" value="4-5">
                                              4:00 PM - 5:00 PM<br />
                                              <input type="radio" name="group11" value="5-6">
                                                5:00 PM - 6:00 PM<br />
                                                <input type="radio" name="group12" value="6-7">
                                                  6:00 PM - 7:00 PM<br />
                                                  <input type="radio" name="group13" value="7-8">
                                                    7:00 PM - 8:00 PM<br />
                                                    <input type="radio" name="group14" value="8-9">
                                                      8:00 PM - 9:00 PM<br />
                                                    </div>
