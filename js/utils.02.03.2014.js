...
*/
  ...
  {
    if(!user[0] || !productStore.getById(user[0].inID) || !usersLoaded)
    {
  ...
  function waitLoading3()
  {
    ...
    else {var role = productStore.getById(user[0].inID).data.role; if(paymentReturn || socialShareReturn || rateReturn) {return;} if(role=='find') {showSearch("",2);} else if(role=='give') {showSelectServices(2);}}
  }
  ...
  function loadInfoFromLinkedIn()
  {
    ...
    IN.API.Profile(currUserID)
      ...
      for(var key in result.values)
      {
        ...
        productStore.getById(inID).data.image = profile.pictureUrls.values ? profile.pictureUrls.values[0] : "http://s.c.lnkd.licdn.com/scds/common/u/images/themes/katy/ghosts/person/ghost_person_60x60_v1.png";
    ...
    function setLoginBadge(profile) {
      ...
      var company = '--';
      var position = '--';
      var image = profile.pictureUrls.values ? profile.pictureUrls.values[0] : "http://s.c.lnkd.licdn.com/scds/common/u/images/themes/katy/ghosts/person/ghost_person_60x60_v1.png";
...
else if(addr == 'rate')
{
  ...
  window.showLabel = function(n)
  {
    ...
    if(initStr.length)
    {
      ...
      if(settings[ID]['identity']) {label = "Confidential"; image = "http://s.c.lnkd.licdn.com/scds/common/u/images/themes/katy/ghosts/person/ghost_person_60x60_v1.png"; link = "Confidential";}
    ...
    if(Ext.get("labelName"))
    {
      ...
      Ext.get("labelCompany").fadeOut({opacity: 0.3, easing: 'easeIn', duration: 100, callback: function() {document.getElementById('labelCompany').innerHTML = company;} });
...
function applySchedule()
{
  ...
  if(thisAppt)
  {
    ...
    addMailMessage('YOU HAVE AN APPOINTMENT FOR:<br>' + apptDay + '<br>' + thisAppt, true);
  }
  else
  {
    ...
    addMailMessage('YOU CLEARED YOUR APPOINTMENT FOR:<br>' + apptDay + '<br>' + thisAppt, true);
  }
...
function makeAppt()
{
  ...
  if(document.getElementById("infoContents"))
  {
    ...
    title.id = "calTitle";
    title.innerHTML = '<div class="sidebar"><ul class="contact"><li><p><span class="name"></span><em id="labelName">' + name + '\'s' + ' calendar</em></p></li></ul></div>';
  ...
  if(document.getElementById("infoContents"))
  {
    ...
    if(document.getElementById("infoContentsWrapper"))
    {
      ...
      if(!document.getElementById("ratingsContainer"))
      {
        ...
        title.innerHTML = '<div class="sidebar"><ul class="contact"><li><p><span class="name"></span><em id="labelName">' + name + '\'s' + ' ratings</em></p></li></ul></div>';
        title.style.marginTop = 0 + "px";
        container.appendChild(title);
...
function applySelection()
{
  ...
  if(thisAppt)
  {
    ...
    addMailMessage('YOU HAVE ADDED AVAILABILITY FOR:<br>' + apptDay + '<br>' + thisAppt, true);
  }
  else
  {
    ...
    addMailMessage('YOU CLEARED YOUR AVAILABILITY FOR:<br>' + apptDay + '<br>' + thisAppt, true);
  }
  Ext.get("showApptAdded").fadeIn({opacity: 1.0, easing: 'easeIn', duration: 100});
...
function showCalendar(parent)
{
  ...
  if(! document.getElementById("showCal"))
  {
    ...
    gear.innerHTML = '<div class="gear-up" onmouseover="this.style.cursor=\'pointer\'; this.className=\'gear-dn\';" onmouseout="this.className=\'gear-up\';" onclick="showSelectAvailability();"></div>';
...
function loadMail()
{
  ...
  {
    addMailMessage('Welcome ' + user[0].first + ' to Interview Ring.  If you have not yet done so, take a moment and browse the vast resouces and services offered.<br>Thank you!<br>-Interview Ring Team', true);
  ...
  var msgs = Ext.JSON.decode(productStore.getById(user[0].inID).data.mail);
  //console.log(messages);
  //for (var key in messages)
  for (var key in msgs)
  {
    addMailMessage(msgs[key], false);
  }//for (var key in calendar)
...
function addMailMessage(msg, flag)
{
  ...
  image.src = "http://s.c.lnkd.licdn.com/scds/common/u/images/themes/katy/ghosts/person/ghost_person_60x60_v1.png";
...
function loadCartItems(id, isReturn)
{
  ...
  for (var key in cartItems)
  {
    ...
    var ID = split[0];
    var day = split[1];
    var image = (productStore.getById(ID) && settings[ID]['identity'] != true) ? productStore.getById(ID).data.image || "http://s.c.lnkd.licdn.com/scds/common/u/images/themes/katy/ghosts/person/ghost_person_60x60_v1.png" : "http://s.c.lnkd.licdn.com/scds/common/u/images/themes/katy/ghosts/person/ghost_person_60x60_v1.png";
...
function populateShareElement()
{
  ...
  var feedback = Ext.JSON.decode(productStore.getById(ID).data.feedback);
  var JSONStr = Ext.JSON.encode(feedback[JSONKey]);
...
function populateRateForm()
{
  ...
  if(ratingObj)
  {
    ...
    for(var i = rating; i < 5; i++)
    {
      ratingStr += '<img src="images/0.gif" onclick="javascript:addStar(\'' + i + '\');" onmouseover="this.style.cursor = \'pointer\';" style="z-index: 999; position: relative; top: -6px; left: -280px; margin-right: -4px; height: 14px;"/>';
      ratingStr += '<img id="' + i + '" src="images/emptyStar.png" style="z-index: 99; position: relative; top: -6px; left: -270px; margin-right: -6px; height: 15px;"/>';
    }
    for(var i = 0; i < rating; i++)
    {
      ratingStr += '<img src="images/0.gif" onclick="javascript:addStar(\'' + i + '\');" onmouseover="this.style.cursor = \'pointer\';" style="z-index: 999; position: relative; top: -6px; left: -280px; margin-right: -4px; height: 14px;"/>';
      ratingStr += '<img id="' + i + '" src="images/filledStar.png" style="z-index: 99; position: relative; top: -6px; left: -270px; margin-right: -6px; height: 15px;"/>';
    }
...
window.addStar = function(num)
{
  ...
  if(num < 4 || gStars < 5)
  {
    ...
    for(var i = num; i >=0; i--)
    {
      document.getElementById(i).src = "images/emptyStar.png";
      gStars++;
    }
    for(var i = num; i < 5; i++)
    {
      document.getElementById(i).src = "images/filledStar.png";
      //gStars--;
    }
  }
  else
  {
    document.getElementById(num).src = filled ? "images/emptyStar.png" : "images/filledStar.png";
    if(filled) {gStars = 0;}
    else       {gStars = 1;}
  }
